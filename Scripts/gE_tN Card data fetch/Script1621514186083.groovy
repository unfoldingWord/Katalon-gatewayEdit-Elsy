...
if(WebUI.verifyElementVisible(findTestObject('Object Repository/tN Card/tN_Reference11')))
{
	println("Data is loaded in tN card ")
}
else {
	println("Data is not loading in tN card")
}
